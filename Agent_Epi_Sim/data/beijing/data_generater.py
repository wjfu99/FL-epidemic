...
def main():
    ...
    if parameters == 'Omicron':
        np.save('./processed_data/sample_result_old_omicron.npy', sample_dict)
        np.save('./processed_data/per_data_old_omicron.npy', period_data)
    else:
        np.save('./processed_data/sample_result_old.npy',sample_dict)
        np.save('./processed_data/per_data_old.npy',period_data)
