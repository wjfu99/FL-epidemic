...
class RNNModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, sparse_idx, edge_weights, conv_method, logger=None, **model_kwargs):
        super().__init__()
        ...
        self.encoder_model = EncoderModel(sparse_idx, edge_weights, self.conv, **model_kwargs)
